...
namespace Borsa_Andrei_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Borsa_Andrei_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Borsa_Andrei_Lab8Context context,
